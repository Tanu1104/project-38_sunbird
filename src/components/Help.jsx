    ...
    <div className="min-h-screen bg-black text-white pt-32 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          Welcome to the Inity Help Center. Get assistance with product setup, troubleshooting, and more.
        </p>

        <div className="space-y-8">
          <div className="border border-gray-800 p-6 rounded-lg">
            <h2 className="text-2xl font-semibold mb-4 text-[#E10600]">Product Setup Guides</h2>
            <div className="space-y-4">
              <div className="bg-gray-900 p-4 rounded">
                <h3 className="text-lg font-medium mb-2">Setting Up Your Inity Headphones</h3>
                <p className="text-gray-400">
                  Learn how to pair your Inity wireless headphones with Bluetooth devices, adjust settings, and use advanced features.
                </p>
              </div>
              <div className="bg-gray-900 p-4 rounded">
                <h3 className="text-lg font-medium mb-2">Inity App Installation</h3>
                <p className="text-gray-400">
                  Download and install the Inity companion app for custom EQ settings, firmware updates, and more.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-800 p-6 rounded-lg">
            <h2 className="text-2xl font-semibold mb-4 text-[#E10600]">Troubleshooting</h2>
            <div className="space-y-4">
              <div className="bg-gray-900 p-4 rounded">
              ...
              <div className="bg-gray-900 p-4 rounded">
                ...
                <ul className="text-gray-400 list-disc pl-5 space-y-2">
                  ...
                  <li>Use original Inity charging cable</li>
          ...
          <div className="border border-gray-800 p-6 rounded-lg">
            <h2 className="text-2xl font-semibold mb-4 text-[#E10600]">Contact Support</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-900 p-5 rounded">
                ...
                <a href="mailto:support@inity.com" className="text-[#E10600] hover:text-[#B30500]">
                  support@inity.com
                </a>
              ...
              <div className="bg-gray-900 p-5 rounded">
                ...
                <button className="px-4 py-2 bg-[#E10600] hover:bg-[#B30500] rounded font-medium">
                  Start Live Chat
                </button>
